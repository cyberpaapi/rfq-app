...
export default function ItemsPage() {
  ...
  return <div className="min-w-0 space-y-5">
    ...
    <Card className="min-w-0 overflow-hidden">
      ...
      {loading ? <Spinner label="Loading items…" /> : !result?.items.length ? <div className="p-8"><Empty icon="items" title="No items match" hint="Try another name, SKU, category or MPN." /></div> : <div className="max-h-[70vh] overflow-auto">
