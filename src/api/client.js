...
export const Rfqs = {
  ...
  quoteUploadQueued: (id, file, supplierId) => api.upload(`/rfqs/${id}/quote-upload-queue`, file, { supplierId }),
  retryQuoteJob: (id, jobId, supplierId) => api.post(`/rfqs/${id}/quote-jobs/${jobId}/retry`, { supplierId }),
